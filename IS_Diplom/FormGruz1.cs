...
namespace IS_Diplom
{
    public partial class FormGruz1 : Form
    {
        public FormGruz1()
        {
            InitializeComponent();
        ...
        public void Upd8()
        {
            ...
            cmnd.Parameters.Add("@st", NpgsqlTypes.NpgsqlDbType.Varchar).Value = "Одобрено. Ожидане погрузки";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            cmnd3.Parameters.Add("@st", NpgsqlTypes.NpgsqlDbType.Varchar).Value = "Погруженно";
