...
namespace IS_Diplom
{
    public partial class FormDeliv : Form
    {
        public FormDeliv()
        {
            InitializeComponent();
        ...
        public void Upd8()
        {
            ...
            db.openConn();
            NpgsqlCommand cmnd = new NpgsqlCommand("Select name,name_prod,typ,status from public.\"Order\" where status=@st or status=@st2", db.getConnection());

            cmnd.Parameters.Add("@st", NpgsqlTypes.NpgsqlDbType.Varchar).Value = "Погруженно";
            cmnd.Parameters.Add("@st2", NpgsqlTypes.NpgsqlDbType.Varchar).Value = "В Пути";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            cmnd3.Parameters.Add("@st", NpgsqlTypes.NpgsqlDbType.Varchar).Value = "В Пути";
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            cmnd3.Parameters.Add("@nameo", NpgsqlTypes.NpgsqlDbType.Varchar).Value = textBox1.Text;
            cmnd3.Parameters.Add("@nameop", NpgsqlTypes.NpgsqlDbType.Varchar).Value = textBox2.Text;
            cmnd3.Parameters.Add("@st", NpgsqlTypes.NpgsqlDbType.Varchar).Value = "Ожидание разгрузки";
            if (cmnd3.ExecuteNonQuery() == 1)
            {
                MessageBox.Show("Статус обновлён");
                db.closeConn();
