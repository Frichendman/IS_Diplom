...
namespace IS_Diplom
{
    public partial class FormPoluch : Form
    {
        public FormPoluch()
        {
            InitializeComponent();
        ...
        public void Upd8()
        {
            ...
            cmnd.Parameters.Add("@st", NpgsqlTypes.NpgsqlDbType.Varchar).Value = "Разгруженно";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            cmnd3.Parameters.Add("@st", NpgsqlTypes.NpgsqlDbType.Varchar).Value = "Плученно";
